...
const PDFSectionListContainer = ({ listTitle, sectionList }) => {
    return (<PDFSectionListContainer_styled_1.PDFSectionListContainerStyled>
      <PDFTypography_1.default fWeight={"b"} value={listTitle} margin="7px 0 0 0"/>
      <SectionList_1.default list={sectionList}/>
    </PDFSectionListContainer_styled_1.PDFSectionListContainerStyled>);
};
