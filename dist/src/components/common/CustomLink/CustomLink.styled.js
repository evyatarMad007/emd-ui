...
import { breakPoints, colors, fonts, layout, linkTypes } from "../../../../ui-settings";
const { sideBar, header } = layout;
const { sideBar: sideBarLink, subHeader: subHeaderLink, sideBarSettings: sideBarSettingsLink, } = linkTypes;
